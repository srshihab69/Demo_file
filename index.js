...
app.post(`/api/webhook`, async (req, res) => {
    try {
        ...
        // ==============================================================================
            ...
            const matchParam = text.print ? text.match(/[?&]start=(srmeta_[a-zA-Z0-9]+)/) : text.match(/[?&]start=(srmeta_[a-zA-Z0-9]+)/);
            if (matchParam) {
            ...
            if (msg.photo || msg.video || msg.animation || msg.document || msg.audio || msg.voice) {
                ...
                } else if (telegramCheck = msg.document) {
                ...
                // FIX: Separated the Title block from the Details block so Telegram treats them as distinct independent quote boxes (just like your screenshot)
