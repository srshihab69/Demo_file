    ...
    try {
        ...
        if (text.startsWith('/start')) {
            ...
            await bot.sendMessage(chatId, 
                `<blockquote>🔗 <b>Supported Links</b></blockquote>\n\n` +
                `<blockquote>🤖 This bot supports only links generated by the bot itself:\n` +
                `├─ 🔗 Direct Media Links\n` +
                `└─ 📤 Shared Media Links\n\n` +
                `⚠️ Other types of links are not supported.</blockquote>`, 
                { parse_mode: 'HTML' }
            );
        }
